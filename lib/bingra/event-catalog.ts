...
const SOCCER_PROFILES: SportProfileKey[] = [
  "soccer_youth",
  "soccer_high_school",
  "soccer_college",
  "soccer_pro",
...
function profilePoints(input: BasketballLevelPointsInput | ProfilePointsByKey): ProfilePointsByKey {
  if ("youth" in input || "hs" in input || "college" in input || "pro" in input) {
    const basketballInput = input as BasketballLevelPointsInput;

    return {
      ...(basketballInput.youth !== undefined
        ? { basketball_youth: basketballInput.youth }
        : basketballInput.hs !== undefined
          ? { basketball_youth: basketballInput.hs }
          : {}),
      ...(basketballInput.hs !== undefined
...
export const EVENT_CATALOG: GameEventType[] = [
  {
    ...
    category: "score",
    scoringByProfile: profilePoints({ youth: 6, hs: 5, college: 6, pro: 6 }),
  ...
  },
  {
    ...
    category: "score",
    scoringByProfile: profilePoints({ youth: 22, hs: 20, college: 7, pro: 7 }),
  ...
  },
  {
    ...
    category: "score",
    scoringByProfile: profilePoints({ youth: 40, hs: 35, college: 15, pro: 14 }),
  ...
  },
  {
    ...
    category: "score",
    scoringByProfile: profilePoints({ youth: 120, hs: 100, college: 14, pro: 8 }),
  ...
  },
  {
    ...
    category: "score",
    scoringByProfile: profilePoints({ hs: 30, college: 18, pro: 16 }),
  ...
  },
  {
    ...
    category: "score",
    maxThreshold: 3,
    scoringByProfile: profilePoints({ youth: 25, hs: 25, college: 8, pro: 7 }),
...

  {
    ...
    scoringByProfile: profilePoints({ youth: 28, hs: 25, college: 8, pro: 7 }),
    rarityByProfile: profileRarity({ hs: 2, college: 2, pro: 2 }),
    enabledProfiles: BASKETBALL_PROFILES,
    enabled: true,
    allowedModes: ["classic", "streak"],
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ youth: 35, hs: 30, college: 10, pro: 9 }),
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ youth: 45, hs: 40, college: 14, pro: 16 }),
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ youth: 22, hs: 20, college: 16, pro: 14 }),
    rarityByProfile: profileRarity({ hs: 2, college: 2, pro: 2 }),
    enabledProfiles: BASKETBALL_PROFILES,
    enabled: true,
    allowedModes: ["classic", "streak"],
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ youth: 22, hs: 20, college: 8, pro: 10 }),
    rarityByProfile: profileRarity({ hs: 2, college: 2, pro: 2 }),
    enabledProfiles: BASKETBALL_PROFILES,
    enabled: true,
    allowedModes: ["classic", "streak"],
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ youth: 22, hs: 20, college: 18, pro: 18 }),
    rarityByProfile: profileRarity({ hs: 2, college: 2, pro: 2 }),
    enabledProfiles: BASKETBALL_PROFILES,
    enabled: true,
    allowedModes: ["classic", "streak"],
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ youth: 22, hs: 20, college: 12, pro: 12 }),
    rarityByProfile: profileRarity({ hs: 2, college: 2, pro: 2 }),
    enabledProfiles: BASKETBALL_PROFILES,
    enabled: true,
    allowedModes: ["classic", "streak"],
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ youth: 14, hs: 12, college: 7, pro: 7 }),
    rarityByProfile: sameRarityForProfiles(BASKETBALL_PROFILES, 1),
    enabledProfiles: BASKETBALL_PROFILES,
    enabled: true,
    allowedModes: ["classic", "streak"],
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ youth: 18, hs: 15, college: 7, pro: 7 }),
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ hs: 35, college: 18, pro: 18 }),
    rarityByProfile: profileRarity({ hs: 4, college: 3, pro: 3 }),
    enabledProfiles: BASKETBALL_PROFILES,
    enabled: true,
    allowedModes: ["classic", "streak"],
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ hs: 25, college: 18, pro: 16 }),
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ hs: 25, college: 20, pro: 22 }),
    rarityByProfile: sameRarityForProfiles(BASKETBALL_PROFILES, 3),
    enabledProfiles: BASKETBALL_PROFILES,
    enabled: true,
    allowedModes: ["classic", "streak"],
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ hs: 30, college: 16, pro: 16 }),
    rarityByProfile: sameRarityForProfiles(BASKETBALL_PROFILES, 3),
    enabledProfiles: BASKETBALL_PROFILES,
    enabled: true,
    allowedModes: ["classic", "streak"],
  ...
  },
  {
    ...
    category: "timeout",
    maxThreshold: 3,
    scoringByProfile: profilePoints({
      basketball_youth: 5,
      basketball_high_school: 5,
      basketball_college: 5,
      basketball_pro: 4,
      soccer_youth: 5,
      soccer_high_school: 5,
      soccer_college: 5,
      soccer_pro: 5,
    }),
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ youth: 35, college: 18, pro: 14 }),
  ...
  },
  {
    ...
    category: "change_of_possession",
    scoringByProfile: profilePoints({ youth: 30, college: 14, pro: 12 }),
...

  {
    ...
    scoringByProfile: profilePoints({
      soccer_youth: 60,
      soccer_high_school: 65,
      soccer_college: 80,
      soccer_pro: 95,
    }),
    rarityByProfile: profileRarity({
      soccer_youth: 4,
      soccer_high_school: 4,
      soccer_college: 4,
      soccer_pro: 5,
    }),
  ...
  },
  {
    ...
    scoringByProfile: profilePoints({
      soccer_youth: 40,
      soccer_high_school: 40,
      soccer_college: 50,
      soccer_pro: 60,
    }),
    rarityByProfile: profileRarity({
      soccer_youth: 3,
      soccer_high_school: 3,
      soccer_college: 3,
      soccer_pro: 4,
    }),
    enabledProfiles: SOCCER_PROFILES,
  ...
  },
  {
    ...
    scoringByProfile: profilePoints({
      soccer_youth: 30,
      soccer_high_school: 30,
      soccer_college: 38,
      soccer_pro: 45,
    }),
    rarityByProfile: profileRarity({
      soccer_youth: 2,
      soccer_high_school: 2,
      soccer_college: 3,
      soccer_pro: 3,
    }),
    enabledProfiles: SOCCER_PROFILES,
  ...
  },
  {
    ...
    scoringByProfile: profilePoints({
      soccer_youth: 18,
      soccer_high_school: 18,
      soccer_college: 22,
      soccer_pro: 28,
    }),
    rarityByProfile: profileRarity({
      soccer_youth: 1,
      soccer_high_school: 1,
      soccer_college: 2,
      soccer_pro: 3,
    }),
    enabledProfiles: SOCCER_PROFILES,
