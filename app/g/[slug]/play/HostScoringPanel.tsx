...
import type { ScorerParentCategory } from "../../../../lib/binga/event-catalog";
import {
  getEventById,
...
export function HostScoringPanel({ slug, isFinished = false }: HostScoringPanelProps) {
  ...
  const subtypeOptions = useMemo(() => {
    const subtypeGroup = selectedEventOption?.subtypeGroup ?? "none";
    return subtypeGroup !== "none" ? getScorerSubtypeOptions(subtypeGroup) : [];
  }, [selectedEventOption]);
